...
def parse(dic_lote):
    ...
    header_str = '{:0>3.3}{:0>4.4}{:<1.1}{:0>5.5}{:<1.1}{:<1.1}{:<2.2}{:0>3.3}{:0>3.3}{:0>5.5}{:0>1.1}{:0>13.13}{:<1.1}{:<30.30}{:0>15.15}{:0>5.5}{:<8.8}{:<3.3}{:0>15.15}{:0>15.15}{:0>20.20}{:<8.8}{:0>15.15}{:<40.40}{:<2.2}{:<5.5}{:<2.2}{:<3.3}{:0>1.1}{:<10.10}'
...
def default():
    ...
    odict['info_pix'] = ''
    odict['G004'] = ''
    odict['finalidade_ted'] = ''
    odict['finalidade_complementar'] = ''
    odict['G004_1'] = ''
    odict['aviso'] = '0'
    odict['ocorrencias'] = ''
    return odict
